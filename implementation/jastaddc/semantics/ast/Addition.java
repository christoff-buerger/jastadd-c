...
public class Addition extends BinaryExpression implements Cloneable {
    public void flushCache() {
        super.flushCache();
    }
     @SuppressWarnings({"unchecked", "cast"})  public Addition clone() throws CloneNotSupportedException {
        Addition node = (Addition)super.clone();
        node.in$Circle(false);
        node.is$Final(false);
    return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public Addition copy() {
      try {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Addition fullCopy() {
        Addition res = (Addition)copy();
    ...
    // Declared in C99AST.ast line 620
