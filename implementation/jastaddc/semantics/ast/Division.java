...
public class Division extends BinaryExpression implements Cloneable {
    public void flushCache() {
        super.flushCache();
    }
     @SuppressWarnings({"unchecked", "cast"})  public Division clone() throws CloneNotSupportedException {
        Division node = (Division)super.clone();
        node.in$Circle(false);
        node.is$Final(false);
    return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public Division copy() {
      try {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Division fullCopy() {
        Division res = (Division)copy();
    ...
    // Declared in C99AST.ast line 618
