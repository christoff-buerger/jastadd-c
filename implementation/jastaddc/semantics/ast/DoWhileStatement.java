...
public class DoWhileStatement extends ConditionalControlFlowStatement implements Cloneable {
    public void flushCache() {
        super.flushCache();
        ControlFlowSuccessor_visited = -1;
    }
     @SuppressWarnings({"unchecked", "cast"})  public DoWhileStatement clone() throws CloneNotSupportedException {
        DoWhileStatement node = (DoWhileStatement)super.clone();
        node.ControlFlowSuccessor_visited = -1;
        node.in$Circle(false);
        node.is$Final(false);
    return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public DoWhileStatement copy() {
      try {
          DoWhileStatement node = (DoWhileStatement)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public DoWhileStatement fullCopy() {
        DoWhileStatement res = (DoWhileStatement)copy();
    ...
    // Declared in C99AST.ast line 459
    ...
    // Declared in C99AST.ast line 459
    public DoWhileStatement(Expression p0, Statement p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in ControlFlow.jrag at line 70
 @SuppressWarnings({"unchecked", "cast"})     public java.util.Set<Statement> ControlFlowSuccessor() {
    ...
    // Declared in ControlFlow.jrag at line 72
    ...
    // Declared in ContextInformationAccess.jrag at line 32
