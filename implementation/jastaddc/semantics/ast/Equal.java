...
public class Equal extends BinaryExpression implements Cloneable {
    public void flushCache() {
        super.flushCache();
    }
     @SuppressWarnings({"unchecked", "cast"})  public Equal clone() throws CloneNotSupportedException {
        Equal node = (Equal)super.clone();
        node.in$Circle(false);
        node.is$Final(false);
    return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public Equal copy() {
      try {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Equal fullCopy() {
        Equal res = (Equal)copy();
    ...
    // Declared in C99AST.ast line 628
