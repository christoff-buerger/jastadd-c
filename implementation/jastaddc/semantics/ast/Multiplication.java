...
public class Multiplication extends BinaryExpression implements Cloneable {
    public void flushCache() {
        super.flushCache();
    }
     @SuppressWarnings({"unchecked", "cast"})  public Multiplication clone() throws CloneNotSupportedException {
        Multiplication node = (Multiplication)super.clone();
        node.in$Circle(false);
        node.is$Final(false);
    return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public Multiplication copy() {
      try {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Multiplication fullCopy() {
        Multiplication res = (Multiplication)copy();
    ...
    // Declared in C99AST.ast line 617
