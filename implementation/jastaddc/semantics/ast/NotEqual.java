...
public class NotEqual extends BinaryExpression implements Cloneable {
    public void flushCache() {
        super.flushCache();
    }
     @SuppressWarnings({"unchecked", "cast"})  public NotEqual clone() throws CloneNotSupportedException {
        NotEqual node = (NotEqual)super.clone();
        node.in$Circle(false);
        node.is$Final(false);
    return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public NotEqual copy() {
      try {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public NotEqual fullCopy() {
        NotEqual res = (NotEqual)copy();
    ...
    // Declared in C99AST.ast line 629
