...
public class StructureTypeReference extends AtomicType implements Cloneable {
    public void flushCache() {
        super.flushCache();
        ReferencedStructureType_visited = -1;
        Name_visited = -1;
        ReadableTypeName_visited = -1;
        IsCorrectLocal_visited = -1;
    }
     @SuppressWarnings({"unchecked", "cast"})  public StructureTypeReference clone() throws CloneNotSupportedException {
        StructureTypeReference node = (StructureTypeReference)super.clone();
        node.ReferencedStructureType_visited = -1;
        node.Name_visited = -1;
    ...
    return node;
     ...
     @SuppressWarnings({"unchecked", "cast"})  public StructureTypeReference copy() {
      try {
          StructureTypeReference node = (StructureTypeReference)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public StructureTypeReference fullCopy() {
        StructureTypeReference res = (StructureTypeReference)copy();
    ...
    // Declared in C99AST.ast line 283
    ...
    // Declared in C99AST.ast line 283
    public StructureTypeReference(List<TypeQualifier> p0, Identifier p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    protected int ReferencedStructureType_visited = -1;
    // Declared in ContextInformationAccess.jrag at line 111
 @SuppressWarnings({"unchecked", "cast"})     public Structure ReferencedStructureType() {
        if(ReferencedStructureType_visited == state().boundariesCrossed)
            throw new RuntimeException("Circular definition of attr: ReferencedStructureType in class: ");
        ReferencedStructureType_visited = state().boundariesCrossed;
        Structure ReferencedStructureType_value = ReferencedStructureType_compute();
        ReferencedStructureType_visited = -1;
        return ReferencedStructureType_value;
    }

    private Structure ReferencedStructureType_compute() {
    ...
    // Declared in Names.jrag at line 26
...
/**
    ...
    Declared in ReadableTypeNames.jrag at line 9
*/
 @SuppressWarnings({"unchecked", "cast"})     public String ReadableTypeName() {
    ...
    private String ReadableTypeName_compute() {  return "structure type ["+ getReferenceName().Name() +"]";  }
...
/**
    ...
    Declared in LocalConstraints.jrag at line 481
*/
