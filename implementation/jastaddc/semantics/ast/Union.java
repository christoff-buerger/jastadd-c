...
public class Union extends StructuredType implements Cloneable {
    public void flushCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Union clone() throws CloneNotSupportedException {
        Union node = (Union)super.clone();
        node.Name_visited = -1;
    ...
    return node;
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Union copy() {
      try {
          Union node = (Union)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public Union fullCopy() {
        Union res = (Union)copy();
    ...
    // Declared in C99AST.ast line 399
    ...
    // Declared in C99AST.ast line 399
    public Union(List<TypeQualifier> p0, Opt<Identifier> p1, List<UnionOrStructureElement> p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in Names.jrag at line 12
 @SuppressWarnings({"unchecked", "cast"})     public String Name() {
    ...
    private String Name_compute() {  return hasTag() ? getTag().Name() : "§Anonymous Union Type "+ NodeAddress().toString() +"§";  }

    protected int ReadableTypeName_visited = -1;
/**
	 * Provide functionality to print human readable type descriptions.
	 
    Declared in ReadableTypeNames.jrag at line 90
*/
...
/**
    ...
    Declared in CompilerAPI.jrag at line 463
*/
 @SuppressWarnings({"unchecked", "cast"})     public Type buildQualifiedReference() {
    ...
    private Type buildQualifiedReference_compute() {  return new UnionTypeReference(buildTypeQualifierCopy(), new Identifier(Name()));  }
